...
//                            goodsEntity.setGoodsName(data.get(0));                    //手工艺品名称 要改的
//                            goodsEntity.setGoodsPhoto("");//详情和图片
//                            goodsEntity.setGoodsTypes(Integer.valueOf(data.get(0)));   //手工艺品类型 要改的
//                            goodsEntity.setGoodsKucunNumber(Integer.valueOf(data.get(0)));   //手工艺品库存 要改的
//                            goodsEntity.setGoodsOldMoney(data.get(0));                    //手工艺品原价 要改的
