    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="手工艺品名称" prop="qiugouName">
                       <el-input v-model="ruleForm.qiugouName"
                                 placeholder="手工艺品名称" clearable  :readonly="ro.qiugouName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="手工艺品名称" prop="qiugouName">
                           <el-input v-model="ruleForm.qiugouName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="求购价格" prop="qiugouNewMoney">
                       <el-input v-model="ruleForm.qiugouNewMoney"
                                 placeholder="求购价格" clearable  :readonly="ro.qiugouNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="求购价格" prop="qiugouNewMoney">
                           <el-input v-model="ruleForm.qiugouNewMoney"
                                     placeholder="求购价格" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   qiugouNewMoney: [
                              { required: true, message: '求购价格不能为空', trigger: 'blur' },
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`qiugou/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.qiugouCrossAddOrUpdateFlag = false;
                                        this.parent.search();
