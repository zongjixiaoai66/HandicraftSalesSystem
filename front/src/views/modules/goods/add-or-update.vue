    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="shangjiaId" name="shangjiaId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="手工艺品名称" prop="goodsName">
                       <el-input v-model="ruleForm.goodsName"
                                 placeholder="手工艺品名称" clearable  :readonly="ro.goodsName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="手工艺品名称" prop="goodsName">
                           <el-input v-model="ruleForm.goodsName"
                                     placeholder="手工艺品名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.goodsPhoto" label="手工艺品照片" prop="goodsPhoto">
                        <file-upload
                            tip="点击上传手工艺品照片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.goodsPhoto" label="手工艺品照片" prop="goodsPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.goodsPhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="手工艺品类型" prop="goodsTypes">
                        <el-select v-model="ruleForm.goodsTypes" :disabled="ro.goodsTypes" placeholder="请选择手工艺品类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="手工艺品类型" prop="goodsValue">
                        <el-input v-model="ruleForm.goodsValue"
                            placeholder="手工艺品类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="手工艺品库存" prop="goodsKucunNumber">
                       <el-input v-model="ruleForm.goodsKucunNumber"
                                 placeholder="手工艺品库存" clearable  :readonly="ro.goodsKucunNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="手工艺品库存" prop="goodsKucunNumber">
                           <el-input v-model="ruleForm.goodsKucunNumber"
                                     placeholder="手工艺品库存" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="手工艺品原价" prop="goodsOldMoney">
                       <el-input v-model="ruleForm.goodsOldMoney"
                                 placeholder="手工艺品原价" clearable  :readonly="ro.goodsOldMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="手工艺品原价" prop="goodsOldMoney">
                           <el-input v-model="ruleForm.goodsOldMoney"
                                     placeholder="手工艺品原价" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="手工艺品简介" prop="goodsContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.goodsContent" label="手工艺品简介" prop="goodsContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   goodsName: [
                              { required: true, message: '手工艺品名称不能为空', trigger: 'blur' },
                          ],
                   goodsPhoto: [
                              { required: true, message: '手工艺品照片不能为空', trigger: 'blur' },
                          ],
                   goodsTypes: [
                              { required: true, message: '手工艺品类型不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   goodsKucunNumber: [
                              { required: true, message: '手工艺品库存不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   goodsOldMoney: [
                              { required: true, message: '手工艺品原价不能为空', trigger: 'blur' },
                   ...
                   goodsContent: [
                              { required: true, message: '手工艺品简介不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
