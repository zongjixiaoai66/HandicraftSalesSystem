        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='goods'">
                    <el-form-item class="select" v-if="type!='info'"  label="手工艺品" prop="goodsId">
                        <el-select v-model="ruleForm.goodsId" :disabled="ro.goodsId" filterable placeholder="请选择手工艺品" @change="goodsChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='goods' ">
                    <el-form-item class="input" v-if="type!='info'"  label="手工艺品名称" prop="goodsName">
                        <el-input v-model="goodsForm.goodsName"
                                  placeholder="手工艺品名称" clearable readonly></el-input>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='goods' ">
                    <el-form-item class="input" v-if="type!='info'"  label="手工艺品类型" prop="goodsValue">
                        <el-input v-model="goodsForm.goodsValue"
                                  placeholder="手工艺品类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='goods' ">
                    <el-form-item class="input" v-if="type!='info'"  label="手工艺品原价" prop="goodsOldMoney">
                        <el-input v-model="goodsForm.goodsOldMoney"
                                  placeholder="手工艺品原价" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   goodsId: [
                              { required: true, message: '手工艺品不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
